...
fun providePullToRefresh(state: PullToRefreshLayoutState): @Composable ((modifier : Modifier, state : com.sarang.torang.compose.feed.state.RefreshIndicatorState, onRefresh: (() -> Unit), contents: @Composable (() -> Unit)) -> Unit) =
